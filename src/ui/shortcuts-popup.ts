...
const shortcutList = [
    ...
    { key: 'A', action: 'area-measurement' },
    { key: 'I', action: 'camera-information' },
    { key: 'Z', action: 'distance-measurement' },
    { key: 'S', action: 'splat-size-display' },
    { header: 'selection' },
    ...
    { key: 'Shift + U', action: 'unlock-all-splats' },
    { key: 'O', action: 'toggle-ui-overlay' },
