...
const initShortcuts = (events: Events) => {
    ...
    shortcuts.register(['1'], { event: 'tool.move', toggle: true });
    shortcuts.register(['2'], { event: 'tool.rotate', toggle: true });
    shortcuts.register(['3'], { event: 'tool.scale', toggle: true });
    ...
    shortcuts.register(['B', 'b'], { event: 'tool.brushSelection', toggle: true });
    shortcuts.register(['R', 'r'], { event: 'tool.rectSelection', toggle: true });
    shortcuts.register(['P', 'p'], { event: 'tool.pickerSelection', toggle: true });
