...
import { FlySelectionTool } from './tools/fly-selection-tool'; // Import FlySelectionTool from the renamed file
...
const initShortcuts = (events: Events) => {
    ...
    shortcuts.register(['K', 'k'], { event: 'tool.flySelection', sticky: true }); // Added shortcut K for fly selection
...
const main = async () => {
    ...
    toolManager.register('flySelection', new FlySelectionTool(events, scene)); // Register FlySelectionTool
